...
import { BookOpen, User, Users, Shield, AlertCircle, Loader2 } from 'lucide-react';
import { Alert, AlertDescription } from '@/components/ui/alert';
import { cn } from '@/lib/utils';
import { toast } from 'sonner';

const roles: { value: UserRole; label: string; icon: typeof User; description: string }[] = [
  { value: 'professor', label: 'Professor', icon: BookOpen, description: 'Create and grade exams' },
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-background to-primary/5 p-4">
      <div className="w-full max-w-md space-y-8 animate-fade-up">
        ...
        <div className="text-center">
          ...
          <p className="text-muted-foreground mt-2">Exam Grading Platform</p>
        </div>
