...
Uses machine learning models (sentence-transformers + TF-IDF) for improved answer matching
"""
import re
import pickle
import os
...
class MLMatcher:
    """
    Machine learning-based answer matcher.
    ...
    def train_on_dataset(self, dataset_path: str):
        """
        Train the matcher on a dataset.
        
        Args:
            dataset_path: Path to CSV dataset with question-answer pairs
        """
        try:
            import pandas as pd
