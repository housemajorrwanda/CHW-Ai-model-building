"""
Training script for ML-enhanced grading model
Trains on Rwanda exam dataset for improved answer matching
"""
import os
import sys
import logging
...
def main():
    ...
    dataset_path = script_dir.parent.parent / "grading_dataset_enhanced.csv"
    model_path = script_dir / "models" / "grading_model.pkl"
    ...
    try:
        ...
        logger.info("")
        logger.info("The enhanced matching engine will automatically load this model.")
